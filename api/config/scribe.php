...
return [
    ...
    'description' => 'Besouhola CRM API (Laravel + Sanctum + Multi-tenant)',
...
INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Get a token by calling <code>POST /api/auth/login</code> (tenant) or <code>POST /api/login</code> (central), then send it as <code>Authorization: Bearer ...</code>. For tenant-scoped requests, also send <code>X-Tenant-Id</code>.',
    ],
    ...
    'strategies' => [
        ...
        'headers' => [
            ...
            Strategies\StaticData::withSettings(data: [
                ...
                // Multi-tenant context (recommended for mobile clients).
        ...
        // Disable ResponseCalls by default to keep doc generation deterministic (many endpoints require auth/tenant context and sample data).
        // You can re-enable it later when you have stable seed data + SCRIBE_AUTH_KEY set.
